...
export class RCL5 extends RCLPlan
{
    public generate()
    {
        ...
        const storageLinkPos = new RoomPosition(this.baseSpawn.pos.x + 3, this.baseSpawn.pos.y + 1, this.room.name);
        ...
        this.room.memory.roomPlan.rcl[5].tower = this.room.memory.roomPlan.rcl[5].tower.concat([
            new RoomPosition(this.baseSpawn.pos.x + 8, this.baseSpawn.pos.y + 8, this.room.name)
        ]);
